...
namespace bootcamp.Solutions
{
    public class Lab5
    {
        ...
        {
            int a1 = int.Parse(System.Console.ReadLine());
            int b1 = int.Parse(System.Console.ReadLine());
            int c1 = int.Parse(System.Console.ReadLine());
            int a2 = int.Parse(System.Console.ReadLine());
            int b2 = int.Parse(System.Console.ReadLine());
            int c2 = int.Parse(System.Console.ReadLine());
        ...
        {
            int a = int.Parse(System.Console.ReadLine());
            char N = char.Parse(System.Console.ReadLine());   
            int b = int.Parse(System.Console.ReadLine());
  

            switch(N)
            {
                case '+': System.Console.WriteLine(a + b);  break;
                case '-': System.Console.WriteLine(a - b);  break;
            }
        ...
        public void Problem11()
        {
            ...
            switch(N)
            {
                case 1:
                {
                    ...
                    int narx = M - 500;
                    System.Console.WriteLine(narx / 500 + " "+ narx / 500 % 100);
                    break;
                }
        ...
        public void Problem16()
        {
            ...
            switch(a)
            {
                ...
                case 4: System.Console.WriteLine("tort"); break;
                ...
                case 9: System.Console.WriteLine("toqqiz"); break;
